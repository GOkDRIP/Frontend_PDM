...
public class RegistrarProgresoActivity extends AppCompatActivity {
    ...
    private void enviarProgreso() {
        ...
        // Crear solicitud
        AgregarProgresoRequest req = new AgregarProgresoRequest(fecha, peso, calorias, observaciones);
        FitLifeService service = RetrofitClient.getService();

        // Enviar a servidor
        Call<GenericResponse> call = service.agregarProgreso(req);
        call.enqueue(new Callback<GenericResponse>() {
            ...
            public void onFailure(Call<GenericResponse> call, Throwable t) {
                Toast.makeText(RegistrarProgresoActivity.this, "Error de conexión", Toast.LENGTH_LONG).show();
            }
        });
    }
